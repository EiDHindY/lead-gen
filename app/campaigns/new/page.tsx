...
const AVAILABLE_TYPES = [
    "cafe", "coffeeshop", "bakery", "restaurant", "bar", "pizza",
    "fast_food", "ice_cream", "juice_bar", "tea_house", "dessert_shop",
    "deli", "pub", "wine_bar", "brewery", "steakhouse", "seafood",
    "sushi", "mexican", "italian", "chinese", "indian", "thai",
];
...
export default function NewCampaignPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        const validRules = rules.filter((r) => r.venue_type);
        if (!name || validRules.length === 0) {
            alert("Please enter a campaign name and at least one venue rule");
            return;
        }
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div key={i} className="glass-card p-6">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {AVAILABLE_TYPES.map((type) => (
                                            <button
                                                key={type}
                                                type="button"
                                                onClick={() => updateRule(i, "venue_type", type)}
                                                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${rule.venue_type === type
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updateRule(i, "min_rating", parseFloat(e.target.value))
                                            }
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updateRule(i, "min_opening_days", parseInt(e.target.value))
                                            }
                                            className="w-full accent-primary"
                                        />
                                        <div className="flex justify-between text-xs text-muted">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted text-xs mb-2">
                                        Special criteria the AI should consider when evaluating venues
                                    </p>
                                    <input
                                        type="text"
                ...
                <button
                    type="submit"
                    disabled={saving || !name || !rules.some((r) => r.venue_type)}
